...
Covers: frame_count, frame_len_arith, frame_len_offset, frame_payload_length,
frame_payload_length_from, frame_timestamp.

frame_collision is rejected by the BMDL validator (frame field name collides
with payload field name) and is exercised by the bgen C++ test suite, not
