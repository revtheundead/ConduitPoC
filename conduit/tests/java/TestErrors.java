...
public class TestErrors {
    ...
    void alphaBodyTruncated() {
        ...
        byte[] truncated = new byte[] { 0x01 };
        assertThrows(choice_test.codec.ConduitCodecException.class,
    ...
    void wireEncodingMsgTruncated() {
        byte[] truncated = new byte[] { 0x01, 0x02, 0x03 };
        assertThrows(wire_encodings.codec.ConduitCodecException.class,
    ...
    void bitReaderU8Empty() {
        session_test.codec.BitReader r = new session_test.codec.BitReader(new byte[0]);
        assertThrows(session_test.codec.ConduitCodecException.class, () -> r.readU8());
    }

    @Test
    @DisplayName("BitReader: readU16 on 1-byte data throws")
    void bitReaderU16Short() {
        session_test.codec.BitReader r = new session_test.codec.BitReader(new byte[] { 0x01 });
        assertThrows(session_test.codec.ConduitCodecException.class, () -> r.readU16(true));
    }

    @Test
    @DisplayName("BitReader: readU32 on 2-byte data throws")
    void bitReaderU32Short() {
        session_test.codec.BitReader r = new session_test.codec.BitReader(new byte[] { 0x01, 0x02 });
        assertThrows(session_test.codec.ConduitCodecException.class, () -> r.readU32(true));
    }

    @Test
    @DisplayName("BitReader: readU64 on 4-byte data throws")
    void bitReaderU64Short() {
        session_test.codec.BitReader r = new session_test.codec.BitReader(new byte[] { 0x01, 0x02, 0x03, 0x04 });
        assertThrows(session_test.codec.ConduitCodecException.class, () -> r.readU64(true));
    }
    ...
    void bitReaderReadBitsBeyond() {
        session_test.codec.BitReader r = new session_test.codec.BitReader(new byte[] { 0x01 });
        assertThrows(session_test.codec.ConduitCodecException.class, () -> r.readBits(16));
    }
    ...
    void bitReaderSkipBeyond() {
        session_test.codec.BitReader r = new session_test.codec.BitReader(new byte[] { 0x01 });
        assertThrows(session_test.codec.ConduitCodecException.class, () -> r.skipBits(16));
    }
    ...
    void bitReaderSequentialExhaustion() {
        ...
        r.readU8(); // ok
        r.readU8(); // ok
        assertThrows(session_test.codec.ConduitCodecException.class, () -> r.readU8()); // underflow
    }

    @Test
    @DisplayName("BitReader: remainingBytes reports correctly")
    void bitReaderRemainingBytes() {
        session_test.codec.BitReader r = new session_test.codec.BitReader(new byte[] { 0x01, 0x02, 0x03 });
    ...
    void bitReaderRemainingBits() {
        session_test.codec.BitReader r = new session_test.codec.BitReader(new byte[] { (byte)0xFF });
    ...
    void codecExceptionIsRuntime() {
        session_test.codec.ConduitCodecException ex = new session_test.codec.ConduitCodecException("test");
    ...
    void codecExceptionMessage() {
        ...
        } catch (session_test.codec.ConduitCodecException e) {
