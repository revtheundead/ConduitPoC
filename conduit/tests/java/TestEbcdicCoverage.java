...
public class TestEbcdicCoverage {
    ...
    // ========================================================================
    // ebcdic_test: EbcdicMsg with EBCDIC-encoded label field
    // ========================================================================

    @Test
    @DisplayName("EbcdicMsg: roundtrip with empty string (space-padded)")
    void ebcdicEmptyString() {
        ebcdic_test.EbcdicMsg msg = new ebcdic_test.EbcdicMsg();
        msg.id = 0;
        msg.label = "";
        msg.trailer = 0;
        byte[] encoded = msg.encodeBytes();
        ebcdic_test.EbcdicMsg d = ebcdic_test.EbcdicMsg.decodeBytes(encoded);
        assertEquals(0, d.id);
    ...
    void ebcdicWireSizeConsistent() {
        ebcdic_test.EbcdicMsg msg1 = new ebcdic_test.EbcdicMsg();
        msg1.id = 0;
        msg1.label = "A";
        msg1.trailer = 0;

        ebcdic_test.EbcdicMsg msg2 = new ebcdic_test.EbcdicMsg();
        msg2.id = 0;
        msg2.label = "ABCDEFGH";
        msg2.trailer = 0;
    ...
    void ebcdicDoubleEncode() {
        ...
        ebcdic_test.EbcdicMsg d = ebcdic_test.EbcdicMsg.decodeBytes(data1);
