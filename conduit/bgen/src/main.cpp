...
void print_usage(const char* program) {
    std::cerr << "Usage: " << program << " --input <root.bmdl.xml> --output <dir> [--namespace <ns>] [--language <lang>]\n"
              ...
              << "                   For Java: this is the source root; bgen creates the package\n"
              << "                   subdirectory inside it automatically.\n"
              << "                   Example: --output src/gen with package io.conduit.asterix\n"
              << "                   produces src/gen/io/conduit/asterix/*.java\n"
              << "                   The Gradle/Maven srcDirs should point to this source root,\n"
              << "                   not to the package subdirectory.\n"
