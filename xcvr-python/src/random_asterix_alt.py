...
import random
from conduit.generated.asterix_alt import (
    TimeOfDay, DataSourceId, AircraftIdent,
    Cat007DownlinkRecord, Cat021Record, Cat048Record, Cat253Record,
    Cat007I250, Cat021I250, Cat048I250, Cat253I025, Cat253I050,
...
def rand_fill_cat048_re(rng, re):
    ...
    if rand_bool(rng):
        re.mutable_m4e().set_foe_fri(FoeFriId(rand_u8(rng, 3)))
    if rand_bool(rng):
...
def random_cat007_downlink(rng: random.Random) -> Cat007DownlinkRecord:
    ...
    if rand_bool(rng):
        ...
        if rand_bool(rng):
            ...
            i020.set_foe_fri(FoeFriId(rand_u8(rng, 3)))
    if rand_bool(rng):
...
def random_cat253(rng: random.Random) -> Cat253Record:
    ...
    if rand_bool(rng):
        ...
        i080.set_local_ctrl(Cat253LocalCtrl(1 if rand_bool(rng) else 0))
        i080.set_data_included(Cat253DataIncl.DATA_INCLUDED)
